# globals for x264-0.155-20180923-545de2f.tgz
%global api 155
%global gitdate 20180923
%global gitversion 545de2f
...
Source0: %{name}-0.%{api}-%{snapshot}.tgz
...
BuildRequires: gcc
%{!?_without_gpac:BuildRequires: zlib-devel openssl-devel libpng-devel libjpeg-devel}
